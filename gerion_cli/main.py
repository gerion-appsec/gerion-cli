...
from gerion_cli.commands import secrets_scan, sca_scan, iac_scan, sast_scan, scan_all, report
...
app.command(name="scan-all", help="Run all security scans (Secrets, SCA, IaC, SAST) sequentially.")(scan_all)
